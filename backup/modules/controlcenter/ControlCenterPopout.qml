...
PopoutWrapper {
    ...
    property real mathProgress: 0.0
    property bool mathConfirming: false
    ...
    onCurrentPageChanged: {
        root.mathConfirming = false; // Сброс подтверждения при переходе
    ...
    Item {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    QuickButton {
                        icon: root.mathActive ? "\uf00c" : "\udb81\udc6a"
                        label: "Math"
                        isActive: root.mathActive
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Text {
                    text: root.mathActive ? "Session is currently active." : "Starting a session will enable focus mode:"
                    color: "#aaaaaa"
                    font.pixelSize: 13
                    Layout.fillWidth: true
                ...
                Rectangle {
                    ...
                    implicitHeight: 40
                    radius: 20
                    color: mathPageBtnMouse.containsMouse ? (root.mathActive ? Qt.rgba(1, 0, 0, 0.15) : Qt.rgba(0, 1, 0, 0.15)) : Qt.rgba(1, 1, 1, 0.08)
                    border.color: mathPageBtnMouse.containsMouse ? (root.mathActive ? Qt.rgba(1, 0, 0, 0.3) : Qt.rgba(0, 1, 0, 0.3)) : "transparent"
                    border.width: 1
                    Behavior on color { ColorAnimation { duration: 150 } }
                    
                    Text {
                        anchors.centerIn: parent
                        text: root.mathActive ? "See My Progress" : "Start New Session"
                        color: mathPageBtnMouse.containsMouse ? (root.mathActive ? "#ff5555ff" : "#55ff55") : "#ffffff"
    ...
    Process {
        ...
        onExited: {
            root.mathActive = true
            root.mathSessionChanged()
        }
    }
